...
class CardsPrompt:
    ...
    def show_cards(self, window, player):
        ...
        pygame.draw.rect(window, BLACK, (CARDS_PROMPT_X_AXIS - 4, CARDS_PROMPT_Y_AXIS - 4, CARDS_PROMPT_WIDTH + 4, CARDS_PROMPT_HEIGHT + 4), 4)

        # Write prompt text
        text = CardsPrompt.font.render(player.name + " Resources", True, BLACK)
        text_rect = pygame.Rect(CARDS_PROMPT_X_AXIS + 130, CARDS_PROMPT_Y_AXIS, CARDS_PROMPT_WIDTH, CARDS_PROMPT_HEIGHT)
        window.blit(text, text_rect)

        # Draw Brick Card
        pygame.draw.rect(window, BRICK_COLOR, (CARDS_POSITION_X, CARDS_POSITION_Y, CARD_WIDTH, CARD_HEIGHT))
        brick_text = CardsPrompt.small_font.render('Bricks', True, BLACK)
        window.blit(brick_text, (CARDS_POSITION_X - 3, CARDS_POSITION_Y + CARD_HEIGHT))
        
        # Brick Cards Number
        brick_number = CardsPrompt.font.render(str(player.cards["Brick"]), True, BLACK)
        ...
        lumber_text = CardsPrompt.small_font.render('Lumber', True, BLACK)
        window.blit(lumber_text, (CARDS_POSITION_X + CARDS_SPACING_HELPER - 7, CARDS_POSITION_Y + CARD_HEIGHT))
        
        # Lumber Cards Number
        lumber_number = CardsPrompt.font.render(str(player.cards["Wood"]), True, BLACK)
        ...
        grain_text = CardsPrompt.small_font.render('Ore', True, BLACK)
        window.blit(grain_text, (CARDS_POSITION_X + 2 * CARDS_SPACING_HELPER + 3, CARDS_POSITION_Y + CARD_HEIGHT))

        # Ore Cards Number
        ore_number = CardsPrompt.font.render(str(player.cards["Ore"]), True, BLACK)
        ...
        grain_text = CardsPrompt.small_font.render('Grain', True, BLACK)
        window.blit(grain_text, (CARDS_POSITION_X + 3 * CARDS_SPACING_HELPER, CARDS_POSITION_Y + CARD_HEIGHT))

        # Grain Cards Number
        grain_number = CardsPrompt.font.render(str(player.cards["Wheat"]), True, BLACK)
        ...
        wool_text = CardsPrompt.small_font.render('Wool', True, BLACK)
        window.blit(wool_text, (CARDS_POSITION_X + 4 * CARDS_SPACING_HELPER, CARDS_POSITION_Y + CARD_HEIGHT))

        # Wool Cards Number
        wool_number = CardsPrompt.font.render(str(player.cards["Sheep"]), True, BLACK)
