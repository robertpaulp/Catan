...
PLAYER_BOARD_HEIGHT = HEXAGON_HEIGHT * 2
ICON_SIZE = 30

NAME_POSITION = (PLAYER_BOARD_X_AXIS + 80 + ICON_SIZE * 1.5, PLAYER_BOARD_Y_AXIS + 20)
...
STONE_POSITION = (PLAYER_BOARD_X_AXIS + 90, PLAYER_BOARD_Y_AXIS + 220)
